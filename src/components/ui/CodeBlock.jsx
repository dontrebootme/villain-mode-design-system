...
const customTheme = {
  ...
  styles: [
    ...
    },
    {
      ...
      style: {
        color: '#00FFFF', // Ultron Cyan
      },
    },
    {
      types: ['string', 'char', 'attr-value', 'builtin', 'inserted'],
      style: {
        color: '#FF9D00', // Infinity Gold
      },
    },
    {
      types: ['function', 'class-name'],
      style: {
        color: '#B026FF', // Bright Magenta
      },
    },
    {
      types: ['operator', 'entity', 'url'],
      style: {
        color: '#00C3E3', // Ultron Cyan Dark
      },
    },
    {
      types: ['attr-name', 'variable'],
      style: {
        color: '#FFD700', // Infinity Gold Light
      },
    },
    {
      types: ['selector', 'regex', 'important'],
      style: {
        color: '#FF003C', // Reality Red
      },
    },
  ],
};
