    ...
    <section className="py-16 bg-abyssal-purple/30">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          {/* Primary Buttons */}
          <div>
            <h3 className="text-2xl mb-6 text-ultron-cyan">Primary Buttons</h3>
          ...
          {/* Secondary Buttons */}
          <div>
            <h3 className="text-2xl mb-6 text-ultron-cyan">Secondary Buttons</h3>
            <p className="text-sm text-faded-silver mb-4">
          ...
          {/* Button Examples */}
          <div>
            <h3 className="text-2xl mb-6 text-ultron-cyan">Examples in Context</h3>
            <div className="bg-abyssal-purple border border-facet-grey p-8 space-y-6">
              <div>
                <p className="text-faded-silver mb-3">Call to Action</p>
                <Button>Unleash Power</Button>
              </div>
              <div>
                <p className="text-faded-silver mb-3">Action Pair</p>
              ...
              <div>
                <p className="text-faded-silver mb-3">Button Group</p>
