    ...
    <section className="py-16 bg-abyssal-purple/30">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          {/* Syntax Colors */}
          <div>
            <h3 className="text-2xl mb-6 text-ultron-cyan">Syntax Color Scheme</h3>
            <div className="bg-abyssal-purple border border-facet-grey p-6 mb-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-ultron-cyan"></div>
                  <span className="text-sm">Keywords, Storage - <span className="text-ultron-cyan">Ultron Cyan</span></span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-infinity-gold"></div>
                  <span className="text-sm">Strings, Values - <span className="text-infinity-gold">Infinity Gold</span></span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-faded-silver"></div>
                  <span className="text-sm">Comments - <span className="text-faded-silver italic">Faded Silver</span></span>
                </div>
              </div>
            </div>
          ...
          {/* Features */}
          <div>
            <h3 className="text-2xl mb-6 text-ultron-cyan">Code Block Features</h3>
